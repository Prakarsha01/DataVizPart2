...
let color=d3.scaleSequential()
   .domain([1980,2020])
   .interpolator(d3.interpolateRgbBasis(['yellow','green','orange']));
...
const treatPublisherClass=(FirstAuthorCountry)=>{
    let temp=FirstAuthorCountry.toString().split(' ').join('');
...
let node_elements = main_group.append("g")
    ...
    .attr("class", function (d){
        return treatPublisherClass(d.FirstAuthorCountry)
    })
